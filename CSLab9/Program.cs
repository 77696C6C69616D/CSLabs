namespace CSLab9
{
    class File_
    {
        ...
        public static void File_RandFill(string file_, int number_count, int numbers_per_row)
        {
            ...
            StreamWriter sw = new StreamWriter(file_);
            int i = 0;
            while (true)
            {
        ...
        public static void Write_Factorial(
            string file_,
            List<int> number1_values,
            int numbers_per_row
        )
        {
            StreamWriter sw = new StreamWriter(file_);
        ...
        public static void Total_Fill(
            string file1_ = "total.txt",
            string file2_ = "number2.txt",
            string file3_ = "text2.txt"
        )
        {
            ...
            for (int i = 0; i < lines_.Count(); ++i)
            {
                ...
                {
                    Console.WriteLine(
                        $"{String.Concat(Enumerable.Repeat(" ", max_length - lines_[0].Count()))}{lines_[0]}"
                    );
                    sw.Write(
                        $"{String.Concat(Enumerable.Repeat(" ", max_length - lines_[0].Count()))}{lines_[0]}"
                    );
    ...
    class Program
    {
        public static void Main()
        {
            ...
            Random rand = new Random();
            int number_count = 12,
                numbers_per_row = rand.Next(1, 10);
            bool f = false;
            while (!f)
            {
