namespace CSLab11
{
    class UniStudent
    {
        ...
        public virtual void AddPerson(
            string _name,
            string _surname,
            string _date_of_entry,
            string _bday,
            double _avg_entrance_exam_score
        )
        {
            name.Add(_name);
    ...
    */
    class Aspirant : UniStudent
    {
        ...
        */
        public void AddPerson(
            ...
            string _date_of_entry,
            string _bday,
            string _research_subject,
            double _research_score
        )
        {
            name.Add(_name);
            surname.Add(_surname);
        ...
        public void DisplayPersonAt(int index = 0)
        {
            Console.WriteLine(
                " Імя: "
                    ...
                    + date_of_entry[index]
                    + "\n Предмет дослідження: "
                    + research_subject[index]
                    + "\n Бали за дослідження: "
                    + research_score[index]
                    + "\n"
            );
        }
    ...
    class Program
    {
        public static void Main()
        {
            ...
            {
                stu.AddPerson(
                    name[rnd.Next(0, name.Count())],
                    surname[rnd.Next(0, surname.Count())],
                    "2018",
            ...
            lis.DisplayPerson();
            Console.WriteLine(
                ">> Додавання нового студента до класу Listener \n>> та виведення його в термінал: \n"
            );
